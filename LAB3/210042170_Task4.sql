...
SELECT NAME, ADDRESS FROM PATIENT, APPOINTMENT_INFO WHERE PATIENT.PATIENT_NO = APPOINTMENT_INFO.P_NO AND APPOINTMENT_INFO.APPOINTMENT_DATE= '26-AUG-2023';
...
APPOINTMENT_INFO.D_NAME = DOCTOR.NAME AND APPOINTMENT_INFO.SPECIALIZATION= DOCTOR.SPECIALIZATION AND DOCTOR.SPECIALIZATION='GS' AND DOCTOR.FEE>1500;
